            ...
            {showEn && (
              <div id="buy-intro-en" style={{ margin: '8px 0' }}>
                <p className="publicsite-desc" style={{ margin: '4px 0', opacity: 0.95, fontSize: 'clamp(1.15rem, 2.8vw, 1.7rem)', lineHeight: 1.5, textAlign: 'center', maxWidth: 980 }}>
                  {buyIntroEn || 'Sounds by Arte Registrazioni — here you\'ll find royalty‑free music tracks available to buy and use as you wish. Once you purchase a track, it becomes your property and can no longer be bought by others. Discover your perfect sound: choose a genre, listen to a preview, and buy the track that wins you over! Are you a videomaker, YouTuber, or a creator of reels or social posts? Do you make Rap and need Beats? Need music for podcast or fitness edits, or looking for relaxing music to help you sleep or meditate? Here you can buy, download, and make use of royalty‑free music for every creative adventure!'}
                </p>
              </div>
            )}
          </div>
          <h1 className="publicsite-title">Sounds</h1>
          <div style={{ textAlign: 'center', marginTop: -6, marginBottom: 10 }}>
            <span style={{ color: '#ffd700', opacity: 0.95, fontWeight: 700, letterSpacing: 0.3 }}>Take Your Music</span>
          </div>
          {genres.length === 0 ? (
